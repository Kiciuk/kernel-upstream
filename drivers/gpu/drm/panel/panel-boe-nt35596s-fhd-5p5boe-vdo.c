...
static inline struct boe_nt35596s_fhd_5p5boe_vdo *to_boe_nt35596s_fhd_5p5boe_vdo(struct drm_panel *panel)
{
...
static int boe_nt35596s_fhd_5p5boe_vdo_enable(struct drm_panel *panel)
{
	struct boe_nt35596s_fhd_5p5boe_vdo *ctx = to_boe_nt35596s_fhd_5p5boe_vdo(panel);
	int ret;
...
static int boe_nt35596s_fhd_5p5boe_vdo_disable(struct drm_panel *panel)
{
	struct boe_nt35596s_fhd_5p5boe_vdo *ctx = to_boe_nt35596s_fhd_5p5boe_vdo(panel);
	int ret;
...
static int boe_nt35596s_fhd_5p5boe_vdo_get_modes(struct drm_panel *panel)
{
	...
	mode = drm_mode_duplicate(panel->drm, &boe_nt35596s_fhd_5p5boe_vdo_mode);
	if (!mode)
		return -ENOMEM;
...
static int boe_nt35596s_fhd_5p5boe_vdo_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx->backlight = boe_nt35596s_fhd_5p5boe_vdo_create_backlight(dsi);
	...
	ctx->panel.dev = dev;
	ctx->panel.funcs = &boe_nt35596s_fhd_5p5boe_vdo_panel_funcs;
...
static const struct of_device_id boe_nt35596s_fhd_5p5boe_vdo_of_match[] = {
	{ .compatible = "mdss,boe_nt35596s_fhd_5p5boe_vdo" }, // FIXME
	{ }
};
