...
static inline
struct boe_nt35596s_5p5boe *to_boe_nt35596s_5p5boe(struct drm_panel *panel)
{
	return container_of(panel, struct boe_nt35596s_5p5boe, panel);
}
...
static void boe_nt35596s_5p5boe_reset(struct boe_nt35596s_5p5boe *ctx)
{
...
static int boe_nt35596s_5p5boe_on(struct boe_nt35596s_5p5boe *ctx)
{
...
static int boe_nt35596s_5p5boe_off(struct boe_nt35596s_5p5boe *ctx)
{
	struct mipi_dsi_device *dsi = ctx->dsi;
	struct device *dev = &dsi->dev;
	int ret;
...
static int boe_nt35596s_5p5boe_prepare(struct drm_panel *panel)
{
	struct boe_nt35596s_5p5boe *ctx = to_boe_nt35596s_5p5boe(panel);
	...
	boe_nt35596s_5p5boe_reset(ctx);

	ret = boe_nt35596s_5p5boe_on(ctx);
	if (ret < 0) {
...
static int boe_nt35596s_5p5boe_unprepare(struct drm_panel *panel)
{
	struct boe_nt35596s_5p5boe *ctx = to_boe_nt35596s_5p5boe(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;
	...
	ret = boe_nt35596s_5p5boe_off(ctx);
	if (ret < 0)
...
static const struct drm_display_mode boe_nt35596s_5p5boe_mode = {
...
static int boe_nt35596s_5p5boe_get_modes(struct drm_panel *panel,
						 struct drm_connector *connector)
{
	struct drm_display_mode *mode;

	mode = drm_mode_duplicate(connector->dev, &boe_nt35596s_5p5boe_mode);
	if (!mode)
		return -ENOMEM;
...
static const struct drm_panel_funcs boe_nt35596s_5p5boe_panel_funcs = {
	.prepare = boe_nt35596s_5p5boe_prepare,
	.unprepare = boe_nt35596s_5p5boe_unprepare,
	.get_modes = boe_nt35596s_5p5boe_get_modes,
};

static int boe_nt35596s_5p5boe_bl_update_status(struct backlight_device *bl)
{
...
static int boe_nt35596s_5p5boe_bl_get_brightness(struct backlight_device *bl)
{
	struct mipi_dsi_device *dsi = bl_get_data(bl);
	u16 brightness = bl->props.brightness;
	int ret;
...
static const struct backlight_ops boe_nt35596s_5p5boe_bl_ops = {
	.update_status = boe_nt35596s_5p5boe_bl_update_status,
	.get_brightness = boe_nt35596s_5p5boe_bl_get_brightness,
};

static struct backlight_device *
boe_nt35596s_5p5boe_create_backlight(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	...
	return devm_backlight_device_register(dev, dev_name(dev), dev, dsi,
					      &boe_nt35596s_5p5boe_bl_ops, &props);
}

static int boe_nt35596s_5p5boe_probe(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	struct boe_nt35596s_5p5boe *ctx;
	int ret;
	...
	drm_panel_init(&ctx->panel, dev, &boe_nt35596s_5p5boe_panel_funcs,
		       DRM_MODE_CONNECTOR_DSI);

	ctx->panel.backlight = boe_nt35596s_5p5boe_create_backlight(dsi);
...
static int boe_nt35596s_5p5boe_remove(struct mipi_dsi_device *dsi)
{
	struct boe_nt35596s_5p5boe *ctx = mipi_dsi_get_drvdata(dsi);
	int ret;
...
static const struct of_device_id boe_nt35596s_5p5boe_of_match[] = {
	{ .compatible = "mdss,nt35596s-fhd-5p5boe-vdo" }, // FIXME
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, boe_nt35596s_5p5boe_of_match);

static struct mipi_dsi_driver boe_nt35596s_5p5boe_driver = {
	.probe = boe_nt35596s_5p5boe_probe,
	.remove = boe_nt35596s_5p5boe_remove,
	.driver = {
		.name = "panel-boe-nt35596s-5p5boe",
		.of_match_table = boe_nt35596s_5p5boe_of_match,
	},
};
module_mipi_dsi_driver(boe_nt35596s_5p5boe_driver);
